      ...
      <section className="section contact-section">
        <div className="container contact-grid">
          ...
          <form className="contact-form" onSubmit={submit}>
            {sent ? (
              <div className="submitted-state submitted-state-contact">
                <Send size={35} />
                <h3>Message on its way.</h3>
                <p>Thanks for getting in touch. A member of our team will reply shortly.</p>
                <button type="button" className="text-link text-link-dark" onClick={() => setSent(false)}>
              ...
              <>
                ...
                <label>I&apos;m looking for
                  <select required defaultValue="">
                    ...
                    <option>Internships & project work</option>
                    <option>Job opportunities</option>
                    <option>Something else</option>
                  </select>
                </label>
                <label>Message<textarea required rows={6} placeholder="Tell us a little about what you’re working on..." /></label>
                <button className="button button-primary form-submit" type="submit">Send message <ArrowRight size={16} /></button>
              </>
            )}
          </form>
        </div>
